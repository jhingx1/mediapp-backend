INSERT INTO paciente (nombres, apellidos,direccion,dni,email,telefono) VALUES ('Juan','Garcia Pérez','Calle Fatima','12345678','juan@gmail.com','987177494');
INSERT INTO paciente (nombres, apellidos,direccion,dni,email,telefono) VALUES ('Pedro','Pérez','Calle Fatima','32456431','pedro@gmail.com','987157492');
...
INSERT INTO paciente(nombres, apellidos, dni, email, telefono) VALUES('TITO', 'RUIZ', '72301953' , 'carlos@gmail.com', '991855570');
...
INSERT INTO paciente(nombres, apellidos, dni, email, telefono) VALUES('GUSTAVO', 'RUIZ', '72901381' , 'carlos@gmail.com', '991855572');
...
INSERT INTO paciente(nombres, apellidos, dni, email, telefono) VALUES('ROBERTO CARLOS', 'NASSARIO', '79301384' , 'Rcarlos@gmail.com', '991855577');

INSERT INTO medico (nombres, apellidos,CMP,foto_url) VALUES ('Gregorio','House','3123123','https://acortar.link/fqZlx');
INSERT INTO medico (nombres, apellidos,CMP,foto_url) VALUES ('Carlos','Mendez','23534423','https://acortar.link/cMX9Q');
INSERT INTO medico (nombres, apellidos,CMP,foto_url) VALUES ('Dr Strange','Strange','34423','https://i.blogs.es/f52810/doctor-strange-poster/450_1000.jpg');
INSERT INTO medico (nombres, apellidos,CMP,foto_url) VALUES ('Dr Frio','Frio','4567678','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSFTivKgqqyMKtXgula6U0bUVR7U1WKLT2Uqw&usqp=CAU');
INSERT INTO medico (nombres, apellidos,CMP,foto_url) VALUES ('Dr gero','Gero','8674','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT9RkQpz08YIOTiX7xsVz835B9mqT-mQyfwwg&usqp=CAU');
INSERT INTO medico (nombres, apellidos,CMP,foto_url) VALUES ('Tony','Stark','24239','https://media.revistagq.com/photos/5ec50516affc6618c4a2fd30/master/pass/iron-man-2008.jpg');

INSERT INTO public.examen(descripcion, nombre) VALUES ('En ayunas', 'SANGRE');
INSERT INTO public.examen(descripcion, nombre) VALUES ('Beber liquidos', 'RAYOS X');

INSERT INTO public.especialidad(descripcion,nombre) VALUES ('CORAZON','CARDIOLOGIA');
INSERT INTO public.especialidad(descripcion,nombre) VALUES ('ATENCION MENORES','PEDIATRIA');

-- consulta
INSERT INTO consulta(fecha, num_consultorio, id_especialidad, id_medico, id_paciente) VALUES ('2021-05-28 16:05:02', 'C1', 1, 1, 1);
INSERT INTO consulta(fecha, num_consultorio, id_especialidad, id_medico, id_paciente) VALUES ('2021-05-27 16:30:02', 'C5', 2, 2, 2);
INSERT INTO consulta(fecha, num_consultorio, id_especialidad, id_medico, id_paciente) VALUES ('2021-05-26 16:40:02', 'C10', 1, 2, 1);
INSERT INTO consulta(fecha, num_consultorio, id_especialidad, id_medico, id_paciente) VALUES ('2021-05-25 16:50:02', 'C12', 2, 1, 2);
